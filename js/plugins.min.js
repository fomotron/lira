...
function InitPage() {
    ...
    state.address && contract.getBuerIncomeInvestment(state.address).call().then(output => {
        ...
        if (user_have_count > 0) {
            ...
            $("#recommond_link h6 a").html(link_str);
            $("#recommond_link h6 a").attr("href", link_str);
    ...
    state.address && contract.balanceOf(state.address).call().then(output => {
...
var state = {
    ...
    game_info: {},
    owner: "",
    tron_domain: "https://nile.tronscan.org"
};
...
jQuery(document).ready(function(s) {
    ...
    $(function() {
        ...
        $.get("./json/LeeLa.json", function(data) {
